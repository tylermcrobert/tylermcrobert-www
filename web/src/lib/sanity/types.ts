...
// Query: {  "dots": dots,  "frameBackground": frameBackground,  "frameForeground": frameForeground,  "sectionBackground": sectionBackground,  "style": style,}
export type WEB_FRAME_THEME_PROJECTIONResult = {
	dots: never;
	frameBackground: never;
	frameForeground: never;
	sectionBackground: never;
	style: never;
};
...
// Query: {  _type,  _key,  // groq  _type == 'mediaBlock' => {    media{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},    aspect  },  // groq  _type == 'textBlock' => {    richText[]{  ..., "markDefs": coalesce(    markDefs[]{      ...,      _type == "internalLink" => {        'type': @.reference->_type,        "slug": @.reference->slug.current      }    },     []  )},  },  //groq  _type == 'website' => {    backgroundImg,    "backgroundColor": backgroundColor.hex,    showFrame,    media{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},  },  //groq  _type == 'diptych' => {    items[]{      _type,      _type == 'diptych.media' => {        media{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},        aspect,      },            _type == 'diptych.text' => {        richText[]{  ..., "markDefs": coalesce(    markDefs[]{      ...,      _type == "internalLink" => {        'type': @.reference->_type,        "slug": @.reference->slug.current      }    },     []  )}      }    }  },  //groq  _type == 'tripleImage' => {    mainMedia{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},    secondaryMedia1{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},    secondaryMedia2{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},    imageRight,  },  //groq  _type == 'mobileWebsite' => {    "themeBackground": theme->.background.hex,    frames[]{      _type == 'mobileWebsite.item' => {        media{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),}      }    }  },  //groq  _type == 'timedSlides' => {    images,    seconds,    'background': theme->background.hex  },  //groq  _type == 'playlistBlock' => {    playlist->{  "slug": slug.current,  link,  title,  duration,   date,  image,  tracks[]{    image,    title,     duration,     artists,  }}  }}
export type MODULES_PROJECTIONResult = {
	_type: never;
	_key: never;
};
// Variable: ROOT_SLUG_QUERY
// Query: *[(_type == 'caseStudy' || _type == 'page') && slug.current == $slug][0]{    _type,    _id,    _type == 'caseStudy' => {      "caseStudy": {        "theme": coalesce(          @.browserFrame{  "dots": dots,  "frameBackground": frameBackground,  "frameForeground": frameForeground,  "sectionBackground": sectionBackground,  "style": style,},          *[_id == "settings"][0].defaultBrowserFrameV2{  "dots": dots,  "frameBackground": frameBackground,  "frameForeground": frameForeground,  "sectionBackground": sectionBackground,  "style": style,}        ),        intro,        deliverables,        date,        title,        description,        browserFrame      },    },        title,    metadata,    modules[]{  _type,  _key,  // groq  _type == 'mediaBlock' => {    media{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},    aspect  },  // groq  _type == 'textBlock' => {    richText[]{  ..., "markDefs": coalesce(    markDefs[]{      ...,      _type == "internalLink" => {        'type': @.reference->_type,        "slug": @.reference->slug.current      }    },     []  )},  },  //groq  _type == 'website' => {    backgroundImg,    "backgroundColor": backgroundColor.hex,    showFrame,    media{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},  },  //groq  _type == 'diptych' => {    items[]{      _type,      _type == 'diptych.media' => {        media{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},        aspect,      },            _type == 'diptych.text' => {        richText[]{  ..., "markDefs": coalesce(    markDefs[]{      ...,      _type == "internalLink" => {        'type': @.reference->_type,        "slug": @.reference->slug.current      }    },     []  )}      }    }  },  //groq  _type == 'tripleImage' => {    mainMedia{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},    secondaryMedia1{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},    secondaryMedia2{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),},    imageRight,  },  //groq  _type == 'mobileWebsite' => {    "themeBackground": theme->.background.hex,    frames[]{      _type == 'mobileWebsite.item' => {        media{  "_type": "mediaProjection",  "asset": select(    defined(@.image) => {      "_type": "image",      "image": @.image    },    defined(@.video.asset) => {      "_type": "video",      "video": @.video.asset-> {        "playbackId": playbackId,        "aspect": data.aspect_ratio,        "poster": ^.poster,        "playbackSettings": ^.playbackSettings,        "customVideoPlayback": ^.customVideoPlayback,      }    },    null  ),}      }    }  },  //groq  _type == 'timedSlides' => {    images,    seconds,    'background': theme->background.hex  },  //groq  _type == 'playlistBlock' => {    playlist->{  "slug": slug.current,  link,  title,  duration,   date,  image,  tracks[]{    image,    title,     duration,     artists,  }}  }},  }
	...
	| {
			...
			caseStudy: {
				theme: {
					...
					frameForeground: Color | null;
					sectionBackground: Color | null;
					style: 'accurate' | 'simple' | null;
				} | null;
				intro: string | null;
