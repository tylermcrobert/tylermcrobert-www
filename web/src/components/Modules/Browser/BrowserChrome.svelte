	...
	>
		<g fill="none" fill-rule="evenodd">
			<path
				...
				fill="var(--chrome-background)"
			/>
			<circle fill="var(--chrome-dots, #FF6158)" cx="6.5" cy="6.5" r="2.5" />
			<circle fill="var(--chrome-dots, #FFBE2D)" cx="22.5" cy="6.5" r="2.5" />
			<circle fill="var(--chrome-dots, #27C93F)" cx="14.5" cy="6.5" r="2.5" />
		</g>
	</svg>
{/snippet}
...
{#snippet browserChromeAccurate()}
	<svg fill="none" viewBox="0 0 1440 52">
		<path d="M0 0h1440v52H0Z" fill="var(--chrome-background)" />
		...
		<rect
			...
			height="12"
			rx="6"
			fill="var(--chrome-dots, #27C93F)"
		/>

		<!-- FWD/BK -->

		<path
			stroke="var(--chrome-foreground)"
			stroke-width="2.25"
		...
		<rect
			...
			height="28"
			rx="7.5"
			stroke="var(--chrome-address-bar-stroke)"
		/>
		<rect
			x="490"
			y="11.5"
			...
			height="27"
			rx="7"
			fill="var(--chrome-address-bar-background)"
		/>
		...
		<text
			...
			font-size="12"
			class="select-none"
			fill="var(--chrome-address-bar-text, var(--chrome-foreground))"
			font-weight="bold"
			text-anchor="middle"
